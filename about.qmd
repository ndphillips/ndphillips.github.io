...
![](assets/portrait_nov24_small.jpeg){width=100%}
...
I believe in transparency. Both in science and in life. For science, this belief has caused me to be a staunch advocate for open-source tools like [R](https://en.wikipedia.org/wiki/R_programming_language) and open-science[^1] methods.

### Belief 4: Create Opportunities for Flow

I believe that the state of [flow](https://en.wikipedia.org/wiki/Flow_(psychology)) is the closest things humans have to a super-power. In periods of flow I have created things that I am immensely proud of (like [FFTrees](https://github.com/ndphillips/FFTrees)). By contrast, in periods of distraction, I feel so inept that I question my brain function.
...
[^1]: See the [Center for Open Science](https://www.cos.io/) website and watch it's YouTube video ["The Open Research Lifecycle"](https://www.youtube.com/watch?v=9YuNGB3vNOw&t=1s&ab_channel=CenterforOpenScience) to learn more
